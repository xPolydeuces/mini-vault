...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name minivault minivault
...
# Build Javascript assets with Bun before Rails asset precompilation
